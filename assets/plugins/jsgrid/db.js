        ...
        loadData: function(filter) {
            return $.grep(this.clients, function(client) {
                return (!filter.Name || client.Name.indexOf(filter.Name) > -1)
                    && (!filter.phone || client.phone.indexOf(filter.Address) > -1)
					&& (!filter.email || client.email.indexOf(filter.Address) > -1)
					&& (!filter.jobtitle || client.jobtitle.indexOf(filter.Address) > -1)
            });
        },
