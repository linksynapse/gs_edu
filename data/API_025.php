<?php
    ...
    try{
        ...
        $SQL = 'SELECT `idx`,(SELECT identify FROM USER where idx=BOARD_NOTICE.uidx) AS identify,`title`,`context`,`CreateTime`,`name_orig`,`name_save` FROM BOARD_NOTICE WHERE idx='.$OPTION.' ORDER BY CreateTime desc LIMIT 5';
